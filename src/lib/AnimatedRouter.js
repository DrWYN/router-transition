...
class AnimatedRouter extends Component {
    ...
    render() {
        ...
        const cls = [prefix, prefix + '-container', 'react-animated-router', className];

      const {transition} = RouterConfig;
      console.log('-->>>>>>transition = ', transition, location);
